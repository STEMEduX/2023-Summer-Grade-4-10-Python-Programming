...
def main():
    ...
    bed_room = {'name':'Bed Room', 'directions':dirs, 'msg':''}
    ...
    hallway['directions'] = (bed_room,kitchen,0,family_room)
    ...
    bed_room['directions'] = (0,0,hallway,0)    

    #rooms where Johnny's basket might be---List
    rooms = [livingroom,hallway,kitchen,diningroom,family_room,bed_room]
